...
import com.ProjetoEscola.web.swagger.ProfessorRestControllerApi;
...
@RequestMapping(value="/rest/professor") //Para colocar nos métodos, se coloca os mesmos parâmetros no GetMapping, PostMapping e etc.
...
public class ProfessorRestController implements ProfessorRestControllerApi {
	...
	public Page<UserResponse> listPagedByKey(
		...
		return professorService.listPagedByKey(key, actualPage, pageSize, order, props);
	}
	...
	public Page<UserResponse> listPaged(
			...
			@RequestParam(value="order", defaultValue="ASC", required=false) String order,
			@RequestParam(value="props", defaultValue="id", required=false) String props) {
		return professorService.listPaged(actualPage, pageSize, order, props);
	}
	...
	public ResponseEntity<?> searchUserById(@PathVariable("id") Long id) {
		UserResponse userResponse = professorService.read(id);
	...
	public ResponseEntity<?> saveUser(@Valid @RequestBody UserRequest userRequest) { //O RequestBody é o comando que lê o que chegou do http
		UserResponse userResponse = professorService.save(userRequest);
	...
	public ResponseEntity<?> updateUser(@PathVariable("id") Long id, @RequestBody UserRequest userRequest) {
		UserResponse updatedUser = professorService.update(id, userRequest);
	...
	public ResponseEntity<?> deleteUser(@PathVariable("id") Long id) {
		...
		SystemMessage<Professor> userMessage = new SystemMessage<Professor>(HttpStatus.OK.value(), "Registro " + id + " excluído com sucesso.", null);
